...
import { DialPad } from "@/components/phone";
...
export default function Header() {
  ...
  // Close dialpad when clicking outside
  useEffect(() => {
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative" ref={dialPadRef}>
          <Button
            ...
            className={cn(
              "text-gray-600 hover:text-brand hover:bg-gray-100 relative",
              showDialPad && "bg-gray-100 text-brand",
              phone.currentCall && "text-green-600"
            )}
          >
